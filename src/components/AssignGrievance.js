...
const AssignGrievance = ({ loggedInUser }) => {
  ...
  // Handle assigning a grievance to a department
          ...
          grievances.map((grievance) => (
            <ListItem key={grievance.id} divider>
              <Grid container spacing={2}>
                ...
                <Grid item xs={3}>
                  <Typography><strong>User Name:</strong> {grievance.user.name || 'N/A'}</Typography>
                  <Typography><strong>User ID:</strong> {grievance.user.id || 'N/A'}</Typography>
                </Grid>
                <Grid item xs={3}>
